...
import com.example.vegies.adapter.AdapterShowProduct;
...
public class activity_Product extends AppCompatActivity {
    ...
    ArrayList<ModelShowProduct> orderProductDetails;
    AdapterShowProduct adapterShowProduct;
    ...
    private void updateProduct() {
        ...
        if(image_uri==null){
            ...
            reference.child(firebaseAuth.getUid()).child("Products").child(Id).updateChildren(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            progressDialog.dismiss();
                            Toast.makeText(activity_Product.this, "Product updated", Toast.LENGTH_SHORT).show();
                         //  activity_Product(MainSellerActivity.loadAllProducts());
                            clearData();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(activity_Product.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        }
        else{
            String filePathAndName="product_images/"+""+productTitle;
    ...
    private void showProduct(final String Id) {

            progressDialog.setMessage("Showing Product...");
            progressDialog.show();
            ...
            if(image_uri==null){
                ...
                DatabaseReference reference= FirebaseDatabase.getInstance().getReference("vegies");
                reference.child(firebaseAuth.getUid()).child("Products").child(Id)
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        try{
                            Picasso.get().load(productIcon).placeholder(R.drawable.ic_add_shopping_cart).into(productIconTv);
                            progressDialog.dismiss();
                        }
                        catch (Exception e){
                    ...
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        Toast.makeText(activity_Product.this, ""+ databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
    }
    ...
    private void showImagePickDialog() {
        ...
        builder.setTitle("Pick Image").setItems(options, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(activity_Product.this, "ok", Toast.LENGTH_SHORT).show();
                if(which==0){
